...
const LocationAutocomplete: React.FC<LocationAutocompleteProps> = ({
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      {shouldShowDropdown && (
        <div ref={listRef} className="fixed left-3 right-3 mt-1 bg-background border border-border rounded-xl shadow-xl z-[300] max-h-80 overflow-y-auto" style={{ top: (containerRef.current?.getBoundingClientRect().bottom ?? 0) + 4 }}>
